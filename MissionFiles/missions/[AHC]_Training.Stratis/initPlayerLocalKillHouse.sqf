...
private _createKillhouseActions = {
    ...
    // Map types
    private _maps = [
        ["알티스", enemy_altis, civ_altis, furniture_altis],
        ["타노아", enemy_tanoa, civ_tanoa, furniture_tanoa],
        ["리보니아아", enemy_livonia, civ_livonia, furniture_livonia]
    ];
...
private _turnOnAction1 = [
    "TurnOn_1","조명 켜기","a3\3den\data\controls\ctrlcheckbox\baseline_texturechecked_ca.paa",
    {
        params ["_target", "_player", "_params"];
...
private _turnOffAction1 = [
    "TurnOff_1","조명 끄기","a3\ui_f\data\igui\cfg\actions\obsolete\ui_action_cancel_ca.paa",
    {
        params ["_target", "_player", "_params"];
        _light = _params select 0;
        {
...
private _mainAction2 = [
    "LightControl_2","킬하우스 2 조명","a3\3den\data\displays\display3den\toolbar\flashlight_off_ca.paa",
    {},
    {true}
] call ace_interact_menu_fnc_createAction;
...
private _turnOnAction2 = [
    "TurnOn_2","조명 켜기","a3\3den\data\controls\ctrlcheckbox\baseline_texturechecked_ca.paa",
    {
        params ["_target", "_player", "_params"];
        _light = _params select 0;
        {
...
private _turnOffAction2 = [
    "TurnOff_2","조명 끄기","a3\ui_f\data\igui\cfg\actions\obsolete\ui_action_cancel_ca.paa",
    {
        params ["_target", "_player", "_params"];
        _light = _params select 0;
        {
