...
_obj addAction ["<t color='#FFFF00'><t size='1.5'>장비 세팅 [에이스]</t></t>", {[player, player, true] call ace_arsenal_fnc_openBox;},nil,4]; 
_obj addAction ["<t color='#FFFF00'><t size='1.5'>장비 세팅 [바닐라]</t></t>", {["Open",true] spawn BIS_fnc_arsenal;},nil,5]; 

[_obj, "<t color='#8A0808'><t size='1.4'>완전 치료 [에이스]</t></t>", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_reviveMedic_ca.paa", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_reviveMedic_ca.paa", "true", "true", {}, {}, 
{ 
...
}, { }, [], 2, 3, false, true] call BIS_fnc_holdActionAdd;
